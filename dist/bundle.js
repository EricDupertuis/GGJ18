...
module.exports = __webpack_require__(/*! /home/eric/Projects/ggj18/src/main.js */333);
...
var _Menu = __webpack_require__(/*! ./states/Menu */ 346);

var _Menu2 = _interopRequireDefault(_Menu);

var _Credits = __webpack_require__(/*! ./states/Credits */ 347);
...
var _class = function (_Phaser$State) {
    ...
    _createClass(_class, [{
        ...
        value: function preload() {
            ...
            this.game.load.atlas('gearBullet', 'assets/spritesheets/small-gear.png', 'assets/spritesheets/small-gear.json');
...
var _Player = __webpack_require__(/*! ../sprites/Player */ 342);

var _Player2 = _interopRequireDefault(_Player);

var _Enemy = __webpack_require__(/*! ../sprites/Enemy */ 343);
...
var _class = function (_Phaser$State) {
    ...
    _createClass(_class, [{
        ...
        value: function init() {
            ...
            this.highScoreString = _config2.default.ui.texts.highscoreText.text;
            this.scoreString = _config2.default.ui.texts.scoreText.text;
            this.livesString = _config2.default.ui.texts.livesText.text;
            this.currentGearText = _config2.default.ui.texts.gearsText.text;
            this.tauntString = _config2.default.ui.texts.tauntText.text;
            this.scoreText = null;
            this.livesText = null;
            this.ui = null;
            this.gearTexts = [];
        ...
        key: 'preload',
        value: function preload() {
            this.load.json('highscores', _config2.default.server.baseUrl + _config2.default.server.getPath);
        }
    }, {
        key: 'createGroundSprite',
        value: function createGroundSprite(x) {
            var y = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

            var s = this.groundGroup.getFirstExists(false);
            if (s === undefined) {
                return;
            }
            ...
            if (Math.random() < _config2.default.background.specialTileProbability) {
                s.frame = special[Math.floor(Math.random() * special.length)];
            } else {
                s.frame = normal[Math.floor(Math.random() * normal.length)];
            }

            s.body.velocity.y = _config2.default.background.scrollSpeed;
        }
    }, {
        ...
        value: function createBackGround() {
            ...
            this.groundGroup.setAll('scale.x', _config2.default.background.scale);
            this.groundGroup.setAll('scale.y', _config2.default.background.scale);
            this.groundGroup.setAll('alpha', _config2.default.background.alpha);

            this.groundGroup.forEach(function (s) {
                s.events.onKilled.add(function (s) {
                    _this2.createGroundSprite(s.body.x, -1);
                }, _this2);
            }, this);

            var w = this.groundGroup.getFirstExists(false).width;

            for (var y = -2 * w; y <= _config2.default.worldBoundY; y += w) {
                for (var x = 0; x < _config2.default.worldBoundX; x += w) {
            ...
            this.cloudGroup.setAll('scale.x', _config2.default.background.clouds.scale.x);
            this.cloudGroup.setAll('scale.y', _config2.default.background.clouds.scale.y);
            this.cloudGroup.setAll('anchor.x', 0.5);
            this.cloudGroup.setAll('anchor.y', 1);
            this.cloudGroup.setAll('alpha', _config2.default.background.clouds.alpha);
        ...
        value: function create() {
            ...
            this.game.world.setBounds(0, 0, _config2.default.worldBoundX, _config2.default.worldBoundY);
            this.stage.backgroundColor = '#000000';

            var highscoreJSON = this.cache.getJSON('highscores');
            ...
            // The enemy's bullets
            var enemyBullets = this.game.add.group();
            ...
            this.rightPanel = new _phaser2.default.Graphics(this.game, _config2.default.worldBoundX, 0);
            ...
            this.ui = this.game.add.sprite(_config2.default.worldBoundX, 0, 'ui');

            this.highScoreText = this.game.add.text(_config2.default.worldBoundX + _config2.default.ui.paddingLeft, _config2.default.ui.texts.highscoreText.y, this.highScoreString + highscoreJSON[0].score, _config2.default.ui.textConfig);

            this.scoreText = this.game.add.text(_config2.default.worldBoundX + _config2.default.ui.paddingLeft, _config2.default.ui.texts.scoreText.y, this.scoreString + this.score, _config2.default.ui.textConfig);

            this.livesText = this.game.add.text(_config2.default.worldBoundX + _config2.default.ui.paddingLeft, _config2.default.ui.texts.livesText.y, this.livesString + this.player.lives, _config2.default.ui.textConfig);

            this.currentGearText = this.game.add.text(_config2.default.worldBoundX + _config2.default.ui.paddingLeft, _config2.default.ui.texts.gearsText.y, _config2.default.ui.texts.gearsText.text, _config2.default.ui.textConfig);

            this.timeText = this.game.add.text(_config2.default.worldBoundX + _config2.default.ui.paddingLeft, _config2.default.ui.texts.timeText.y, 'Remaining time: ', _config2.default.ui.textConfig);

            this.timer = this.game.add.text(_config2.default.worldBoundX + _config2.default.ui.paddingLeft, _config2.default.ui.texts.timerText.y, this.getRemainingTime(), _config2.default.ui.textConfig);

            this.tauntText = this.game.add.text(this.game.world.centerX - 290, 630, this.tauntString, _config2.default.ui.textConfig);

            this.messageBox = this.game.add.sprite(this.game.world.centerX, 700, 'messageBox');
            ...
            for (var i = 0; i < _config2.default.speeds.numberOfGears; i++) {
                this.gearTexts[i] = this.game.add.text(_config2.default.worldBoundX + _config2.default.ui.paddingLeft + _config2.default.ui.texts.gearsText.spacing * i, _config2.default.ui.texts.gearsText.y + 55, i + 1, _config2.default.ui.textConfig);
            }

            this.backgroundMusic.play('', 0, 0.3, true, true);

            this.player.events.onKilled.add(function (s) {
                _this3.backgroundMusic.stop();
                _this3.game.state.start(_config2.default.defeatState, true, false, { hasHighScore: true, score: _this3.score });
            }, this);
        }
    }, {
        key: 'render',
        ...
        value: function getRemainingTime() {
            ...
            return _config2.default.gameDuration - (this.game.time.now - this.gameStartTime) / 1000;
        }
    }, {
        key: 'prettyPrintTime',
        value: function prettyPrintTime(time) {
        ...
        key: 'handlePlayerHit',
        value: function handlePlayerHit(player, object) {
            var _this5 = this;
            ...
            this.player.hitCooldown = this.game.time.now + _config2.default.playerConfig.hitCooldown;

            this.livesText.text = this.livesString + (this.player.lives - 1);

            this.audioPlayerHit.play();

            var explosion = this.player.explosions.getFirstExists(false);
            ...
            // Delete all bullets
            this.fadeExit = this.game.add.tween(this.enemyBullets).to({ alpha: 0 }, 200, 'Linear', true).onComplete.add(function () {
                _this5.enemyBullets.forEach(function (b) {
                    b.kill();
                });
                _this5.enemyBullets.alpha = 1;
            });

            if (this.enemy.game.time.now > _config2.default.enemyConfig.tauntDuration) {
                this.enemy.changeState('taunt');
                this.tauntText.text = _phaser2.default.ArrayUtils.getRandomItem(_config2.default.enemyConfig.tauntMessages);

                this.fadeTaunt = this.game.add.tween(this.tauntGroup).to({ alpha: 1 }, 400, 'Linear', true).onComplete.add(function () {
                    setTimeout(function () {
                        _this5.game.add.tween(_this5.tauntGroup).to({ alpha: 0 }, 400, 'Linear', true).onComplete.add(function () {
                            _this5.enemyBullets.alpha = 1;
                        });
                    }, 1000);
                });
        ...
        value: function update() {
             ...
             * see. */
            var dt = (this.game.time.now - this.previousTime) / 1000;
            this.previousTime = this.game.time.now;

            var p = Math.random();
            if (p < 1 - Math.exp(-_config2.default.background.clouds.rate * dt)) {
                var cloud = this.cloudGroup.getFirstExists(false);

                if (cloud) {
                    var x = Math.random() * _config2.default.worldBoundX;
                    cloud.reset(x, 0);
                    cloud.body.velocity.y = _config2.default.background.clouds.speed;
            ...
            this.groundGroup.forEachAlive(function (s) {
                if (s.body.y > _config2.default.worldBoundY + 128) {
                    s.kill();
                }
            });
            ...
            this.game.physics.arcade.overlap(this.bullets, this.enemy, function (enemy, bullet) {
                bullet.kill();
                _this6.audioHit.play();

                _this6.score += _config2.default.speeds.scoreMultipliers[_this6.player.currentGear - 1];
                _this6.scoreText.text = _this6.scoreString + _this6.score;

                var explosion = _this6.enemy.explosions.getFirstExists(false);
                explosion.scale.setTo(1, 1);
                explosion.animations.add('blueExplosion1');

                explosion.reset(_this6.enemy.body.x + (Math.floor(Math.random() * _this6.enemy.width) + 1), _this6.enemy.body.y + (Math.floor(Math.random() * _this6.enemy.height) + 1));
                explosion.play('blueExplosion1', 30, false, true);
            }, null, this);
...
var _class = function (_Phaser$Sprite) {
    ...
    function _class(_ref) {
        var game = _ref.game,
            ...
            explosions = _ref.explosions;

        _classCallCheck(this, _class);

        var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, game, x, y, asset, bullets));
        ...
        _this.moving = false;
        _this.maxSpeed = _config2.default.speeds.minSpeed * _config2.default.speeds.numberOfGears;
        _this.currentGear = _config2.default.speeds.numberOfGears;
        _this.shiftCooldown = 0;

        _this.bullets = bullets;
        _this.bulletTime = 0;
        _this.hitCooldown = 0;
        _this.explosions = explosions;

        _this.alive = true;
        _this.lives = _config2.default.playerConfig.lives;

        _this.body.setSize(2, 3, 15, 11);
        ...
        _this.mainGunButton = _this.game.input.keyboard.addKey(_phaser2.default.Keyboard.Q);
        _this.shiftUp = _this.game.input.keyboard.addKey(_phaser2.default.Keyboard.E);
        _this.shiftDown = _this.game.input.keyboard.addKey(_phaser2.default.Keyboard.W);
        _this.animations.add('player', null, 20, true, true);
        return _this;
    }
    ...
    _createClass(_class, [{
        ...
        key: 'fireBullet',
        value: function fireBullet(update) {
            var angle = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
            var animation = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
            ...
            if (bullet) {
                ...
                var speed = _config2.default.playerConfig.bulletSpeed;
        ...
        value: function fireBullets() {
            ...
            if (this.game.time.now > this.bulletTime) {
                var angles = _config2.default.playerConfig.shootAngles[this.currentGear - 1];
                angles.forEach(function (a) {
                    _this2.fireBullet(null, a, 'bullet');
                }, this);
        ...
        value: function handleControls() {
            ...
            if (this.game.input.gamepad.supported && this.game.input.gamepad.active && this.pad.connected) {
                if (this.pad.isDown(_phaser2.default.Gamepad.XBOX360_B)) {
                    this.fireBullets();
                }

                var rightStickX = this.pad.axis(_phaser2.default.Gamepad.XBOX360_STICK_LEFT_X);
                var rightStickY = this.pad.axis(_phaser2.default.Gamepad.XBOX360_STICK_LEFT_Y);
                ...
                if (this.pad.isDown(_phaser2.default.Gamepad.XBOX360_LEFT_TRIGGER)) {
                    if (this.currentGear < _config2.default.speeds.numberOfGears) {
                        this.currentGear++;
                        this.maxSpeed = _config2.default.speeds.minSpeed * this.currentGear;
                    }
                } else if (this.pad.isDown(_phaser2.default.Gamepad.XBOX360_RIGHT_TRIGGER)) {
...
var _PatternsLibrary = __webpack_require__(/*! ./PatternsLibrary */ 344);

var _PatternsLibrary2 = _interopRequireDefault(_PatternsLibrary);
...
var _class = function (_Phaser$Sprite) {
    ...
    function _class(_ref) {
        ...
        _this.explosions = explosions;
        _this.audio = audio;
        _this.tauntCooldown = 0;

        _this.patterns = new _PatternsLibrary2.default(_this, _this.game, _this.bullets, _this.player, _this.audio);
        _this.state = _config2.default.enemyConfig.startingState;
        return _this;
    }
    ...
    _createClass(_class, [{
        ...
        key: 'update',
        value: function update() {
            var movementPeriod = _config2.default.enemyConfig.phase2.movementPeriod;
            ...
            if (this.alive) {
                ...
                if (this.state === 'enter') {
                    var duration = _config2.default.enemyConfig.enterDuration * 1000;
                    ...
                    var tauntDuration = _config2.default.enemyConfig.tauntDuration;
                    ...
                    targetX = _config2.default.worldBoundX * 0.1;
                    targetY = this.body.y;
                    ...
                    targetX = _config2.default.worldBoundX * 0.6;
                    targetY = this.body.y;
                }

                var dx = targetX - this.body.x;
                var dy = targetY - this.body.y;

                var kp = _config2.default.enemyConfig.kp;
                var kd = _config2.default.enemyConfig.kd;
                ...
                if (this.state !== 'taunt') {
                    ...
                    var pattern = void 0;
                    if (this.state === 'left') {
                        var name = _config2.default.enemyConfig.phase2.leftPattern;
                        pattern = this.patterns.getPattern(name);
                    } else if (this.state === 'right') {
                        var _name = _config2.default.enemyConfig.phase2.rightPattern;
                        pattern = this.patterns.getPattern(_name);
                    }
...
/* 344 */
/*!****************************************!*\
  !*** ./src/sprites/PatternsLibrary.js ***!
  \****************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var SinePattern = function () {
    function SinePattern(game, bullets, shooter) {
        _classCallCheck(this, SinePattern);
    ...
    _createClass(SinePattern, [{
        key: 'update',
        value: function update() {
            var f = _config2.default.patterns.sinePattern.frequency;
            var speed = _config2.default.patterns.sinePattern.bulletSpeed;
            var interval = _config2.default.patterns.sinePattern.interval;

            var nowTime = this.game.time.now;
            var vx = -Math.sin(nowTime / 1000 * 2 * Math.PI * f) * speed;
            var vy = Math.abs(Math.cos(nowTime / 1000 * 2 * Math.PI * f) * speed);
...
var StraightPattern = function () {
    function StraightPattern(game, bullets, shooter, speed, interval, angle) {
        _classCallCheck(this, StraightPattern);
    ...
    _createClass(StraightPattern, [{
        ...
        value: function update() {
            ...
            if (this.game.time.now > this.bulletTime) {
                ...
                var vx = Math.sin(this.angle) * this.speed;
                var vy = Math.cos(this.angle) * this.speed;
...
var StarPattern = function () {
    function StarPattern(game, bullets, shooter) {
        _classCallCheck(this, StarPattern);

        this.straightPatterns = [];

        var speed = _config2.default.patterns.starPattern.bulletSpeed;
        var interval = _config2.default.patterns.starPattern.interval;
        var angles = _config2.default.patterns.starPattern.angles;
...
var RandomBulletEmitter = function () {
    function RandomBulletEmitter(game, bullets, shooter) {
        _classCallCheck(this, RandomBulletEmitter);
    ...
    _createClass(RandomBulletEmitter, [{
        key: 'update',
        value: function update() {
            var _this = this;
             ...
             * see. */
            var p = Math.random();
            if (p < 1 - Math.exp(-_config2.default.patterns.randomBulletEmitter.rate * dt)) {
                var bullet = this.bullets.getFirstExists(false);

                var angle = Math.random() * Math.PI;

                var speed = _config2.default.patterns.randomBulletEmitter.bulletSpeed * (0.5 + 0.8 * Math.random());
                ...
                if (bullet) {
                    ...
                    bullet.events.onKilled.add(function (b) {
                        var index = _this.ourBullets.indexOf(b);
                        if (index > -1) {
                            _this.ourBullets.splice(index, 1);
                        }
                    });
                }
            }
        ...
        value: function updateBullets() {
            ...
            this.ourBullets.forEach(function (b) {
                var lambda = _config2.default.patterns.randomBulletEmitter.bulletSpeedHalftime;
                var dt = 0.016;
                var decay = Math.exp(dt * Math.log(0.5) / lambda);
                b.body.velocity.x *= decay;
                b.body.velocity.y *= decay;

                var vx = b.body.velocity.x;
                var vy = b.body.velocity.y;
                var speed = Math.sqrt(vx * vx + vy * vy);
                if (speed < _config2.default.patterns.randomBulletEmitter.bulletSpeedMin) {
                    b.body.velocity.x *= _config2.default.patterns.randomBulletEmitter.bulletSpeedMin / speed;
                    b.body.velocity.y *= _config2.default.patterns.randomBulletEmitter.bulletSpeedMin / speed;
                }
            }, this);
        }
    }]);

    return RandomBulletEmitter;
}();

var CrossAimPattern = function () {
    function CrossAimPattern(game, bullets, shooter, player, audio) {
        _classCallCheck(this, CrossAimPattern);
    ...
    _createClass(CrossAimPattern, [{
        key: 'update',
        value: function update() {
            var interval = _config2.default.patterns.crossAimPattern.interval;
            var speed = _config2.default.patterns.crossAimPattern.bulletSpeed;
            var cooldown = _config2.default.patterns.crossAimPattern.cooldown;
            if (this.bulletTime === undefined) {
                this.bulletTime = this.game.time.now + 1000 * interval / speed;
            }
            ...
            if (this.state === 'shooting') {
                ...
                if (this.game.time.now > this.bulletTime) {
                    ...
                    var dx = this.shooter.y - this.player.y;
                    var dy = -this.shooter.x + this.player.x;
                    ...
                    for (var i = -2; i <= 2; i++) {
                        ...
                        if (bullet) {
                            var spread = 75;
                            var bulletX = this.shooter.x + i * spread * dx;
                            var bulletY = this.shooter.y + i * spread * dy;

                            var vx = this.player.x - bulletX;
                            var vy = this.player.y - bulletY;

                            vx *= 1.1;

                            var _norm = Math.sqrt(vx * vx + vy * vy);
                            vx *= speed / _norm;
                            vy *= speed / _norm;
    ...
    return CrossAimPattern;
}();

var CrossEmitter = function () {
    function CrossEmitter(game, bullets, shooter) {
        _classCallCheck(this, CrossEmitter);
    ...
    _createClass(CrossEmitter, [{
        key: 'update',
        value: function update() {
            var rotationSpeed = _config2.default.patterns.crossEmitter.rotationSpeed * Math.PI / 180;
            var interval = _config2.default.patterns.crossEmitter.interval;
            var speed = _config2.default.patterns.crossEmitter.bulletSpeed;
            var N = _config2.default.patterns.crossEmitter.N;
            ...
            if (this.game.time.now > this.bulletTime) {
                ...
                for (var i = 0; i < N; i++) {
                    ...
                    if (bullet) {
                        var angle = this.angle + Math.PI * 2 * (i / N);
                        var vx = Math.cos(angle) * speed;
                        var vy = Math.sin(angle) * speed;
                        bullet.reset(this.shooter.x, this.shooter.y);
                        bullet.body.velocity.x = vx;
...
var PatternCombinator = function () {
    function PatternCombinator(patterns) {
        _classCallCheck(this, PatternCombinator);

        this.patterns = patterns;
    }

    _createClass(PatternCombinator, [{
        key: 'update',
        value: function update() {
    ...
    return PatternCombinator;
}();

var PatternsLibrary = function () {
    function PatternsLibrary(owner, game, bullets, player, audio) {
        _classCallCheck(this, PatternsLibrary);
    ...
    _createClass(PatternsLibrary, [{
        ...
        value: function getPattern(name) {
            ...
            name.split('+').forEach(function (n) {
                res.push(_this2.bulletPatterns[n]);
            });
...
exports.default = PatternsLibrary;
...
var _class = function (_Phaser$State) {
    ...
    _createClass(_class, [{
        ...
        key: 'create',
        value: function create() {
            this.goKey = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.SPACEBAR);
            ...
            this.menuEntries[0] = this.game.add.text(this.game.world.centerX + 300, 300, 'New Game', this.textConfig);
            ...
            this.menuEntries.forEach(function (text) {
        ...
        value: function update() {
            ...
            this.menuEntries.forEach(function (m) {
                m.alpha = 0.8;
            });
        ...
        value: function goFullScreen() {
            this.game.scale.fullScreenScaleMode = _phaser2.default.ScaleManager.SHOW_ALL;
...
var _class = function (_Phaser$State) {
    ...
    _createClass(_class, [{
        key: 'init',
        value: function init() {
            var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { hasHighScore: false, score: 0 };
        ...
        value: function create() {
            ...
            var textConfig = _config2.default.ui.textConfig;
            ...
            if (this.hasHighScore) {
                ...
                setTimeout(function () {
                    ...
                    if (playerName != null) {
                        _this2.postScore(_config2.default.server.baseUrl + _config2.default.server.postPath, playerName, _this2.score);
                    }
                }, 2000);
            }
        ...
        key: 'postScore',
        value: function postScore(path, name, score) {
